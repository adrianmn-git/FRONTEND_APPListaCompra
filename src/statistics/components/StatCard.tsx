...
export default function StatCard({ title, value, subtitle, icon, colorClass = "text-indigo-600 bg-indigo-50" }: StatCardProps) {
  ...
  return (
    <div className="group bg-white p-6 rounded-[2rem] shadow-xl shadow-slate-200/40 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] ring-1 ring-slate-900/5 hover:ring-slate-900/10 transition-all duration-500 hover:-translate-y-1.5 flex items-center gap-6 relative overflow-hidden cursor-default">
      {/* Ambient Glow */}
